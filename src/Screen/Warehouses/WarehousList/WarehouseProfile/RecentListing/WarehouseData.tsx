...
import ListingDatas, {
  ListingData,
} from "../../../../../Data/warehouseProfileTable"; // Ensure the correct path
...
const RecentListings = () => {
  ...
  return (
    <div className="relative overflow-hidden -mt-72 ">
              ...
              {loading ? (
                ...
                currentPartners.map((listing) => (
                  <tr key={listing.SnNo} className="border-b border-gray-300">
                    ...
                    <td className="px-8 py-4">{listing.bookedOn || "N/A"}</td>
                    <td className="px-8 py-4">
                      <span className="mr-2">₹</span>
                      {listing.amount || "N/A"}
                    </td>
                    <td className="px-8 py-4">{listing.bookingBy || "N/A"}</td>
                    <td className="px-8 py-4">{listing.paidAmount || "N/A"}</td>
